 ...
 * bump `engine.io-client`.
 * set `readyState` before engine.io close code
 ...
 * fixes for duplicate code propagation from manager instance [Rase-]
 ...
 * socket: fix code buffering while in disconnected state [kevin-roark]
