...
- [IO](#io)
  ...
  - [Class: io.Manager](#manager)
    ...
    - [Event: 'connect_error'](#code-connect_error)
    - [Event: 'connect_timeout'](#code-connect_timeout)
    - [Event: 'reconnect'](#code-reconnect)
    - [Event: 'reconnect_attempt'](#code-reconnect_attempt)
    - [Event: 'reconnecting'](#code-reconnecting)
    - [Event: 'reconnect_error'](#code-reconnect_error)
    - [Event: 'reconnect_failed'](#code-reconnect_failed)
    - [Event: 'ping'](#code-ping)
    - [Event: 'pong'](#code-pong)
  - [Class: io.Socket](#socket)
    ...
    - [Event: 'connect'](#code-connect)
    - [Event: 'connect_error'](#code-connect_error-1)
    - [Event: 'connect_timeout'](#code-connect_timeout-1)
    - [Event: 'error'](#code-error)
    - [Event: 'disconnect'](#code-disconnect)
    - [Event: 'reconnect'](#code-reconnect-1)
    - [Event: 'reconnect_attempt'](#code-reconnect_attempt-1)
    - [Event: 'reconnecting'](#code-reconnecting-1)
    - [Event: 'reconnect_error'](#code-reconnect_error-1)
    - [Event: 'reconnect_failed'](#code-reconnect_failed-1)
...
An unique identifier for the socket session. Set after the `connect` code is triggered, and updated after the `reconnect` code.
...
Sends a `message` code. See [socket.emit(eventName[, ...args][, ack])](#socketemiteventname-args-ack).
...
Emits an code to the socket identified by the string name. Any other parameters can be included. All serializable datastructures are supported, including `Buffer`.
...
Register a new handler for the given code.
...
The socket actually inherits every method of the [Emitter](https://github.com/component/emitter) class, like `hasListeners`, `once` or `off` (to remove an code listener).
...
Sets a modifier for a subsequent code emission that the code data will only be _compressed_ if the value is `true`. Defaults to `true` when you don't call the method.

```js
socket.compress(false).emit('an code', { some: 'data' });
```
